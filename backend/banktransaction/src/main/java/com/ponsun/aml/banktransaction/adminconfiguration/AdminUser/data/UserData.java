...
public class UserData {
    ...
    public static UserData newInstance(final Integer id,final String userName, final String password, final String adminGroup, final String fullName, final String dob, final Long genderId, final Long maritalStatusId, final String dom, final Long msgDisplayed, final Boolean superUser, final Long admin, final String email, final String phoneNo, final String validFrm, final String validTo, final Boolean valid, final Long orgId) {
        return new UserData(id,userName ,password, adminGroup, fullName, dob, genderId, maritalStatusId, dom, msgDisplayed, superUser, admin, email, phoneNo, validFrm, validTo, valid, orgId);
    }
}
