package com.ponsun.aml.banktransaction.adminconfiguration.adminconfigmoduledet.api;
...
import com.ponsun.aml.banktransaction.adminconfiguration.adminconfigmoduledet.services.AdminConfigModuleDetReadPlatformService;
import com.ponsun.aml.banktransaction.adminconfiguration.adminconfigmoduledet.services.AdminConfigModuleDetWritePlatformService;
...
public class AdminConfigModuleDetApiResource {
    ...
    public Response saveAdminConfigModuleDet(@RequestBody CreateAdminConfigModuleDetRequest createAdminConfigModuleDetRequest) throws AppicationException {
    ...
    @PutMapping("/{id}")
    public Response updateAdminConfigModuleDet(@PathVariable Integer id, @RequestBody UpdateAdminConfigModuleDetRequest updateAdminConfigModuleDetRequest) throws AppicationException {
...
//    }
    ...
    @PutMapping("/block/{id}")
public Response blockAdminConfigModuleDet(@PathVariable Integer id) throws AppicationException {
    Response response = this.adminconfigmoduledetWritePlatformService.blockAdminConfigModuleDet(id);
    return response;
}

    @PutMapping("/{id}/unblock")
    public Response unblockAdminConfigModuleDet(@PathVariable Integer id) throws AppicationException {
