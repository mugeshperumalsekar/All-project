...
import com.ponsun.aml.banktransaction.adminconfiguration.admingroup.data.AdmingroupDataValidator;
import com.ponsun.aml.banktransaction.adminconfiguration.admingroup.domain.Admingroup;
import com.ponsun.aml.banktransaction.adminconfiguration.admingroup.domain.AdmingroupRepository;
import com.ponsun.aml.banktransaction.adminconfiguration.admingroup.domain.AdmingroupRepositoryWrapper;
...
public class AdmingroupWritePlatformServiceImpl implements AdmingroupWritePlatformService {
    ...
    @Transactional
    public Response createAdmingroup(CreateAdmingroupRequest createAdmingroupRequest) throws AppicationException {
        try {
            this.admingroupDataValidator.validateSaveAdmingroup(createAdmingroupRequest);
            final Admingroup admingroup = Admingroup.create(createAdmingroupRequest);
            this.admingroupRepository.saveAndFlush(admingroup);
            return Response.of(Integer.valueOf(admingroup.getId()));
        } catch (DataIntegrityViolationException e) {
    ...
    @Override
    @Transactional
    public Response updateAdmingroup(Integer id, UpdateAdmingroupRequest updateAdmingroupRequest) throws AppicationException {
        try {
            this.admingroupDataValidator.validateUpdateAdmingroup(updateAdmingroupRequest);
            final Admingroup admingroup = this.admingroupRepositoryWrapper.findOneWithNotFoundDetection(id);
            admingroup.update(updateAdmingroupRequest);
    ...
    @Override
    @Transactional
    public Response blockAdmingroup(Integer id) throws AppicationException {
        try {
            final Admingroup admingroup = this.admingroupRepositoryWrapper.findOneWithNotFoundDetection(id);
    ...
    @Override
    @Transactional
    public Response unblockAdmingroup(Integer id) throws AppicationException {
        try {
            final Admingroup admingroup = this.admingroupRepositoryWrapper.findOneWithNotFoundDetection(id);
