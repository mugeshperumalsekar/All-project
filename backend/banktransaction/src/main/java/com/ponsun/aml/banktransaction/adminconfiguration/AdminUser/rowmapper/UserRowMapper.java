package com.ponsun.aml.banktransaction.adminconfiguration.AdminUser.rowmapper;



import com.ponsun.aml.banktransaction.adminconfiguration.AdminUser.data.UserData;
...
public class UserRowMapper implements RowMapper<UserData> {
    ...
    public UserData mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        return new UserData(id,userName,password,adminGroup,fullName,dob,genderId,maritalStatusId,dom,msgDisplayed,superUser,admin,password,email,validFrm,validTo,valid,orgId);
    }
}
