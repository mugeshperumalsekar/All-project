package com.ponsun.aml.banktransaction.adminconfiguration.AdminUser.api;
...
import com.ponsun.aml.banktransaction.adminconfiguration.AdminUser.services.UserReadPlatformService;
import com.ponsun.aml.banktransaction.adminconfiguration.AdminUser.services.UserWritePlatformService;
...
public class UserApiResource {
    ...
    public Response saveUser(@RequestBody CreateUserRequest createUserRequest) throws AppicationException {
    ...
    @PutMapping("/{id}")
    public Response updateUser(@PathVariable Integer id, @RequestBody UpdateUserRequest updateUserRequest) throws AppicationException {
    ...
    @PutMapping("/{id}/block")
    public Response blockUser(@PathVariable Integer id) throws AppicationException {
        Response response = this.userWritePlatformService.blockUser(id);
        return response;
    }

    @PutMapping("/{id}/unblock")
    public Response unblockUser(@PathVariable Integer id) throws AppicationException {
