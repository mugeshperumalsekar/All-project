package com.ponsun.aml.amlTeam.AmlCustomerAllData.rowmapper;
...
@Service
@Slf4j
public class AmlCustomerAllDataRowMapper implements RowMapper<AmlCustomerAllDataData> {
    private final String schema;

    public AmlCustomerAllDataRowMapper() {
    ...
    @Override
    public AmlCustomerAllDataData mapRow(ResultSet rs, int rowNum) throws SQLException {
